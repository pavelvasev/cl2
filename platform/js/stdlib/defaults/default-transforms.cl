...
// idea: set alfa=.. beta=.. { objs } и всем 
// объектам выставляются указанные параметры.
// а сами объекты переводятся в верхнуюю область видимости.
// здесь объекты это объекты, а не process name

// idea: logging { .... } печатать все входы, все выходы
