...
# мы проверяем, что не должно быть такого что print печатает промежуточные результаты
...
############# вручную сделанное - делаем, а именно готовим переменную a, со всеми значениями, в режиме функции
