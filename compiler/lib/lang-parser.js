...
function peg$parse(input, options) {
  ...
  var peg$f24 = function(envid, first_feature_name, env_modifiers, child_envs) {
  ...
  var peg$f25 = function(envid, first_positional_attr, env_modifiers, child_envs) {
    var env = new_env( envid );
    env.locinfo = getlocinfo();
  ...
  var peg$f26 = function(envid, first_positional_attr) {
  ...
  var peg$f27 = function(var_id, env) {
   var let_env = new_env();
