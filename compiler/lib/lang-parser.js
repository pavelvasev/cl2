...
function peg$parse(input, options) {
  ...
  var peg$f10 = function(envid, first_feature_name, env_modifiers, child_envs) {
  ...
  var peg$f11 = function(envid, first_positional_attr, env_modifiers, child_envs) {
      var env = new_env( envid );
      env.locinfo = getlocinfo();
  ...
  var peg$f12 = function(envid, first_positional_attr) {
  ...
  var peg$f13 = function(var_id, env) {
     var let_env = new_env();
