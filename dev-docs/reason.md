...
4. При этом учитываем что широко известные классы - это на самом деле синтаксис и модель для генерации функции, которая порождает структуру данных согласно описанию данному в классе.
