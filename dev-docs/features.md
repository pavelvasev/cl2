...
это оказалось полезно в связи с вводам F-SEQUENTAL и там например мы делаем if и надо выйти из функции вообще. С return который возвращает на уровне блока - такое не получилось бы.
